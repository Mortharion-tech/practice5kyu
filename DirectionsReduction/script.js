...
In ["NORTH", "EAST", "WEST", "SOUTH", "WEST", "WEST"], "NORTH" and "SOUTH" are not directly opposite but they become directly opposite after the reduction of "EAST" and "WEST"
...
function dirReduc(arr) {
    ...
    for (let i=smartArr.length-1; i>=0; i--) {
      if (smartArr[i] === opposites[smartArr[i+1]]) {
        smartArr.splice(i, 2);
      }
    }
    return smartArr;
