...
This algorithm is so inefficient that the time to calculate any Fibonacci number over 50 is simply too much. You may go for a cup of coffee or go take a nap while you wait for the answer.
...
/* 
const fibonacci = (arr => n => arr[n] !== undefined ? arr[n] : arr[n] = fibonacci(n - 1) + fibonacci(n - 2))([0, 1]);
 */